 ...
 * Aqui ele realiza o cálculo de Dk^t * A * Dk. Sendo 'D' o vetor de próxima direção
 * e 'A' a matriz de Coeficientes. 
 *
...
/**
 * @brief Calcula o valor de z, isto é Zĸ = C⁻¹ * Rĸ. Este Z é chamado de 'Y'
 * no livro da M.Cristina C. Cunha.
 * 
 * @link: https://math-linux.com/mathematics/linear-systems/article/preconditioned-conjugate-gradient-method
 * 
